  ...
  return (
    <section className="panel">
        ...
        <>
          ...
          <div className="row-actions">
            ...
            <button
              ...
              disabled={createOrderMutation.isPending || cartQuery.data.items.length === 0}
            >
              Create Order
            </button>
          </div>
      ...
      {createOrderMutation.isSuccess ? (
        <p className="success-text">Order #{createOrderMutation.data.order.id} created successfully.</p>
      ) : null}
    </section>
  )
}
