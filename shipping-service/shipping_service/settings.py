...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "shipping-service-secret-key")
...
ASGI_APPLICATION = "shipping_service.asgi.application"
...
if db_engine == "django.db.backends.sqlite3":
    ...
    default_database_name = os.getenv("DB_NAME", "shipping_db")
