...
SERVICE_ROUTES = {
    ...
    "/api/ai/": os.getenv("AI_SERVICE_URL", "http://ai-service:8007"),
    "/api/payments/": os.getenv("PAYMENT_SERVICE_URL", "http://payment-service:8008"),
    "/api/shipping/": os.getenv("SHIPPING_SERVICE_URL", "http://shipping-service:8009"),
}
