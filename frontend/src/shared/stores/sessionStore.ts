...
type SessionState = {
  ...
  setStaffAuth: (payload: { token: string | null; staffId?: number | null; staffName?: string | null; staffRoles?: string[] }) => void
...
export const useSessionStore = create<SessionState>((set, get) => ({
  ...
  staffRoles: persisted.staffRoles,
  ...
  setStaffAuth: ({ token, staffId = null, staffName = null, staffRoles = [] }) => {
    set({ staffToken: token, staffId, staffName, staffRoles })
    const state = get()
    writePersisted({
      customerToken: state.customerToken,
      customerId: state.customerId,
  ...
  clearAuth: () => {
    set({ customerToken: null, customerId: null, customerUsername: null, staffToken: null, staffId: null, staffName: null, staffRoles: [] })
    const state = get()
    writePersisted({
      customerToken: null,
      customerId: null,
