...
const paths = {
  staff: {
    ...
    adminCreate: "/api/staff/admin_create/",
  },
  customers: {
  ...
  payments: {
    list: "/api/payments",
    detail: (id: string | number) => `/api/payments/${id}`,
    create: "/api/payments",
    confirm: (id: string | number) => `/api/payments/${id}/confirm`,
    fail: (id: string | number) => `/api/payments/${id}/fail`,
    cancel: (id: string | number) => `/api/payments/${id}/cancel`,
    refund: (id: string | number) => `/api/payments/${id}/refund`,
  },
  shipping: {
    shipments: "/api/shipping/shipments",
    shipmentDetail: (id: string | number) => `/api/shipping/shipments/${id}`,
    assignShipper: (id: string | number) => `/api/shipping/shipments/${id}/assign_shipper`,
    shippers: "/api/shipping/shippers",
    shipperDetail: (id: string | number) => `/api/shipping/shippers/${id}`,
    shipperLocation: (id: string | number) => `/api/shipping/shippers/${id}/location`,
    markReady: (id: string | number) => `/api/shipping/shipments/${id}/mark_ready`,
    ship: (id: string | number) => `/api/shipping/shipments/${id}/ship`,
    deliver: (id: string | number) => `/api/shipping/shipments/${id}/deliver`,
    cancel: (id: string | number) => `/api/shipping/shipments/${id}/cancel`,
    fail: (id: string | number) => `/api/shipping/shipments/${id}/fail`,
  },
  interactions: {
